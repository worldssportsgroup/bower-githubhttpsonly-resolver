...
function GitHubHttpsOnlyResolver(decEndpoint, config, logger) {
    var pair;
    ...
    pair = GitHubHttpsOnlyResolver.getOrgRepoPair(this._source);
    if (!pair) {
...
util.inherits(GitHubHttpsOnlyResolver, GitRemoteResolver);
mout.object.mixIn(GitHubHttpsOnlyResolver, GitRemoteResolver);

// -----------------

GitHubHttpsOnlyResolver.prototype._checkout = function () {
    var msg;
    var name =
...
GitHubHttpsOnlyResolver.prototype._savePkgMeta = function (meta) {
...
GitHubHttpsOnlyResolver.getOrgRepoPair = function (url) {
    var match;
...
module.exports = GitHubHttpsOnlyResolver;